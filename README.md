...
1. **Loads and cleans the data** - fixes messy values, handles missing rows, standardises text (like making all region names lowercase)
...
5. **Evaluates accuracy** - checks MAE, MSE, and R2 score to see how good the predictions are
